!(function (e, t) {
            ...
            (super("ClientResponseError"),
                ...
                this.message ||
                    (this.isAbort
                        ...
                        : this.originalError?.cause?.message?.includes(
                                "ECONNREFUSED ::1",
                            )
                          ? (this.message =
    ...
    class BaseAuthStore {
        ...
        exportToCookie(e, t = i) {
            ...
            const a =
                "undefined" != typeof Blob ? new Blob([o]).size : o.length;
            if (r.record && a > 4096) {
        ...
        onChange(e, t = !1) {
            return (
                ...
                () => {
                    for (
                        let t = this._onChangeCallbacks.length - 1;
                        t >= 0;
                        t--
                    )
    ...
    function normalizeUnknownQueryParams(e) {
        if (e) {
            e.query = e.query || {};
            for (let t in e)
                n.includes(t) || ((e.query[t] = e[t]), delete e[t]);
        }
    }
        ...
        async submitSubscriptions() {
            if (this.clientId)
                return (
                    ...
                    (this.lastSentSubscriptions =
                        this.getNonEmptySubscriptionKeys()),
                    this.client
                        .send("/api/realtime", {
                            method: "POST",
                            body: {
                        ...
                        this.submitSubscriptions()
                            ...
                            .then(() => {
                                ...
                                ((this.pendingConnects = []),
                                    ...
                                    clearTimeout(this.connectTimeoutId));
                                const t =
                                    this.getSubscriptionsByTopic("PB_CONNECT");
    ...
    class CrudService extends BaseService {
        ...
        async getList(e = 1, t = 30, s) {
            return (
                ((s = Object.assign({ method: "GET" }, s)).query =
                    Object.assign({ page: e, perPage: t }, s.query)),
                this.client
                    .send(this.baseCrudPath, s)
                    .then(
                        (e) => (
                            (e.items =
                                e.items?.map((e) => this.decode(e)) || []),
                            e
                        ),
                    )
            );
        ...
        async getFirstListItem(e, t) {
            return (
                ((t = Object.assign(
                    {
                        requestKey:
                            "one_by_filter_" + this.baseCrudPath + "_" + e,
                    },
                    t,
    ...
    class RecordService extends CrudService {
        ...
        async update(e, t, s) {
            return super.update(e, t, s).then((e) => {
                if (
                    ...
                    let t = Object.assign(
                            {},
                            this.client.authStore.record.expand,
                        ),
        ...
        authWithOAuth2(...e) {
            ...
            return (
                ...
                this.listAuthMethods(n)
                    .then((e) => {
                        const n = e.oauth2.providers.find(
                            (e) => e.name === t.provider,
                        );
                        if (!n)
                            throw new ClientResponseError(
                                new Error(
                                    `Missing or invalid provider "${t.provider}".`,
                                ),
                            );
                        const o = this.client.buildURL("/api/oauth2-redirect");
                        return new Promise(async (e, a) => {
                            const c = r
                                ? this.client.cancelControllers?.[r]
                                : void 0;
                            (c &&
                                (c.signal.onabort = () => {
                                    (cleanup(),
                            ...
                            try {
                                await i.subscribe("@oauth2", async (s) => {
                                    ...
                                    try {
                                        ...
                                        const a = await this.authWithOAuth2Code(
                                            n.name,
                                            s.code,
                                            n.codeVerifier,
                                            o,
                                ...
                                t.scopes?.length &&
                                    (r.scope = t.scopes.join(" "));
                                const l = this._replaceQueryParams(
                                    n.authURL + o,
                                    r,
                                );
                                let h =
        ...
        async requestPasswordReset(e, t, s) {
            ...
            return (
                ...
                this.client
                    .send(
                        this.baseCollectionPath + "/request-password-reset",
                        i,
                    )
                    .then(() => !0)
            );
        ...
        async impersonate(e, t, s) {
            ...
            return (
                i.authStore.save(n?.token, this.decode(n?.record || {})),
                i
            );
        }
        _replaceQueryParams(e, t = {}) {
            ...
            for (const e of r) {
                if ("" == e) continue;
                const t = e.split("=");
                n[decodeURIComponent(t[0].replace(/\+/g, " "))] =
                    decodeURIComponent((t[1] || "").replace(/\+/g, " "));
            }
            for (let e in t)
                t.hasOwnProperty(e) &&
                    (null == t[e] ? delete n[e] : (n[e] = t[e]));
            i = "";
            for (let e in n)
                n.hasOwnProperty(e) &&
                    ("" != i && (i += "&"),
    ...
    class CollectionService extends CrudService {
        ...
        async import(e, t = !1, s) {
            return (
                ...
                this.client
                    .send(this.baseCrudPath + "/import", s)
                    .then(() => !0)
            );
        }
    ...
    class BatchService extends BaseService {
        ...
        collection(e) {
            return (
                this.subs[e] ||
                    (this.subs[e] = new SubBatchService(this.requests, e)),
                this.subs[e]
            );
        }
        async send(e) {
    ...
    class SubBatchService {
        ...
        prepareRequest(e, t) {
            ...
            for (const t in s) {
                const i = s[t];
                if (isFile(i))
                    ((e.files[t] = e.files[t] || []), e.files[t].push(i));
